      ...
      <section className="space-y-3 pt-4">
        ...
        <div className="space-y-2">
          ...
          <p>
            ...
            our whatsapp number. we index your saves, extract key ideas, send you periodic digests, and — over
        ...
        <div className="space-y-2">
          ...
          <p>
            the services integrate with third-party platforms (such as whatsapp) and use third-party providers
